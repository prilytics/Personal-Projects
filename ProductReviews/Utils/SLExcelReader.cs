...
namespace ProductReviews.Utils
{
    public class SLExcelReader
    {
        ...
        public SLExcelData ReadExcelFromStream(MemoryStream str)
        {
            var data = new SLExcelData();
            ...
            try
            {
                var document = SpreadsheetDocument.Open(str, false);
                workbookPart = document.WorkbookPart;
            ...
            {
                data.Status.Message = "Unable to open the file. Exception=" + e.Message;
                return data;
            }
